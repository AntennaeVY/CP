...
int main() {
	while (1) {
		...
		do {
			...
			printf("\n\t\e[1;97m\e[4;37mSeleccione una opcion:\e[0m ");
...
void banner() {
	system("cls");
	printf("\n\t\t\e[0;37m***- \e[0;31mM\e[0m\e[0;32mA\e[0;33mQ\e[0;34mU\e[0;35mI\e[0;36mN\e[0;37mA \e[0;31mT\e[0;32mR\e[0;33mA\e[0;34mG\e[0;35mA\e[0;36mM\e[0;37mO\e[0;31mN\e[0;32mE\e[0;33mD\e[0;34mA\e[0;35mS \e[0;37m-***\e[0m\n");
}
...
void reglas() {
	...
	printf("\n\t\t\e[1;33mEl juego consiste en que, al ser accionada la palanca, las ruedas comienzan a girar,\n");
...
void botones() {
	printf("\n\n\t\e[1;33m[1]\e[0m \e[1;97mAccionar palanca\e[0m");
	printf("\n\t\e[1;33m[2]\e[0m \e[1;97mSalir\e[0m");
}
...
void tragamonedas(char *slot1, char *slot2, char *slot3) {
	...
	printf(" \e[1;97m==============================\e[0m");
	printf("\n\t\t");
	printf("\e[1;97m/ \e[43m                            \e[0m \\\e[0m");
	printf("\n\t\t");
	printf("\e[1;97m|\e[43m                              \e[0m|\e[0m");
	printf("\n\t\t");
	printf("\e[1;97m|\e[43m     \e[0m\e[41m-----\e[0m\e[43m   \e[0m\e[41m-----\e[0m\e[43m   \e[0m\e[41m-----\e[0m\e[43m    \e[0m|\e[0m");
	printf("\n\t\t");
	printf("\e[1;97m|\e[43m     \e[0m\e[41m|\e[0m\e[47m %s\e[47m \e[0m\e[41m|\e[0m\e[43m   \e[0m\e[41m|\e[0m\e[47m %s\e[47m \e[0m\e[41m|\e[0m\e[43m   \e[0m\e[41m|\e[0m\e[47m %s\e[47m \e[0m\e[41m|\e[0m\e[43m    \e[0m|\e[0m", slot1, slot2, slot3);
	printf("\n\t\t");
	printf("\e[1;97m|\e[43m     \e[0m\e[41m-----\e[0m\e[43m   \e[0m\e[41m-----\e[0m\e[43m   \e[0m\e[41m-----\e[0m\e[43m    \e[0m|\e[0m");
	printf("\n\t\t");
	printf("\e[1;97m|\e[43m                              \e[0m|\e[0m");
...
void jugar () {
	...
	do {
		system("cls");
		printf("\n\t\e[1;97m\e[4;37mIntroduce la cantidad de veces que quieres jugar (MAX 100):\e[0m ");
	...
	do {
		system("cls");
		printf("\n\t\e[1;97m\e[4;37mIntroduce la cantidad inicial de dinero con la que quieres empezar (MAX 1M):\e[0m ");
...
void gameloop(unsigned int intentos, double* dinero) {
	char accion_str[3];
	char *slot1[] = {"\e[1;30m\e[47mA\e[0m", "\e[1;32m\e[47mB\e[0m", "\e[1;32m\e[47mC\e[0m", "\e[1;34m\e[47mS\e[0m", "\e[1;35m\e[47m7\e[0m", "\e[1;35m\e[47mZ\e[0m", "\e[1;30m\e[47mX\e[0m", "\e[42mL\e[0m", "\e[46mO\e[0m"};
	char *slot2[] = {"\e[1;30m\e[47mA\e[0m", "\e[1;32m\e[47mB\e[0m", "\e[1;32m\e[47mC\e[0m", "\e[1;34m\e[47mS\e[0m", "\e[1;35m\e[47m7\e[0m", "\e[1;35m\e[47mZ\e[0m", "\e[1;30m\e[47mX\e[0m", "\e[42mL\e[0m", "\e[46mO\e[0m"};
	char *slot3[] = {"\e[1;30m\e[47mA\e[0m", "\e[1;32m\e[47mB\e[0m", "\e[1;32m\e[47mC\e[0m", "\e[1;34m\e[47mS\e[0m", "\e[1;35m\e[47m7\e[0m", "\e[1;35m\e[47mZ\e[0m", "\e[1;30m\e[47mX\e[0m", "\e[42mL\e[0m", "\e[46mO\e[0m"};
	...
	while(intentos--) {
		do {
			...
			printf("\n\t\e[0;31m[!]\e[0m \e[1;97mIntentos restantes: %d\e[0m", intentos+1);
			printf("\n\t\e[0;32m[$]\e[0m \e[1;97mDinero disponible: %.2f\e[0m", *dinero);
		...
		if (*dinero < 1) {
			system("cls");
			printf("\n\t\e[1;33mLamentablemente la cantidad de dinero con la que dispone no es suficiente para seguir jugando!\n\n\t\e[0m");
			system("pause");
			return;			
		}
		...
		if (accion == 1) {
			...
			*dinero = (*dinero)/2;
			...
			while(contador != 10) {
				...
				printf("\n\t\e[0;31m[!]\e[0m \e[1;97mIntentos restantes: %d\e[0m", intentos);
				printf("\n\t\e[0;32m[$]\e[0m \e[1;97mDinero disponible: %.2f\e[0m", *dinero);
